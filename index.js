...
function CemberinCevresi(yaricap) {
  /* kodlar buraya */
  let çemberinÇevresi=2*pi*yaricap;
  return çemberinÇevresi;
}
...
function CemberinAlani(yaricap,pi) {
  ...
  let çemberinAlani=pi*Math.pow(yaricap,2);
  return çemberinAlani;
}
...
ucebolunenlerintoplami=ucetambolunenler.reduce((acc,eleman)=>eleman+acc,0)
